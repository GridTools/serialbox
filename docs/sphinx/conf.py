# -*- coding: utf-8 -*-
#
# Serialbox documentation build configuration file, created by
...
sys.path.insert(0, os.path.abspath('../../src/serialbox-python'))
...
htmlhelp_basename = 'Serialboxdoc'
...
man_pages = [
    (master_doc, 'serialbox', u'Serialbox Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Serialbox', u'Serialbox Documentation',
     author, 'Serialbox', 'One line description of project.',
     'Miscellaneous'),
]
