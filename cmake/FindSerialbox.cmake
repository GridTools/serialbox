...
if(SERIALBOX_ROOT AND NOT(DEFINED SERIALBOX_NO_EXTERNAL_LIBS))
  ...
  find_package(Boost ${SERIALBOX_BOOST_VERSION} EXACT COMPONENTS ${_REQUIRED_BOOST_COMPONENTS})
  if(Boost_FOUND)
    list(APPEND SERIALBOX_INCLUDE_DIRS ${Boost_INCLUDE_DIRS})
    list(APPEND SERIALBOX_EXTERNAL_LIBRARIES ${Boost_LIBRARIES})
  else()
    message(WARNING 
            "Serialbox depends on the following Boost libraries: ${_REQUIRED_BOOST_COMPONENTS}")
  endif()
...
#====--------------------------------------------------------------------------------------------===
if(SERIALBOX_ROOT)
  find_file(SERIALBOX_PPSER pp_ser.py ${SERIALBOX_ROOT}/python)
endif()
