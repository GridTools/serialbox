...
//
/// \file
/// This implements the unittests of the MetainfoMapImpl.
///
//===------------------------------------------------------------------------------------------===//
...
TEST(MetainfoMapImplTest, Construction) {
  MetainfoMapImpl map;
  ...
  // Modify value
  map["key1"] = MetainfoValueImpl(std::string("value2"));
...
TEST(MetainfoMapImplTest, Comparison) {
  MetainfoMapImpl map1;
  MetainfoMapImpl map2;
...
TEST(MetainfoMapImplTest, Conversion) {
  MetainfoMapImpl map;
...
TEST(MetainfoMapImplTest, fromJSON) {
  // -----------------------------------------------------------------------------------------------
  // Success
  // -----------------------------------------------------------------------------------------------
...
TEST(MetainfoMapImplTest, toString) {
  std::stringstream ss;
